...
const (
	...
	migrationCreateQuotaCycleSnapshots              = "20260526_create_quota_cycle_snapshots"
)
...
func orderedMigrations() []databaseMigration {
	return []databaseMigration{
		...
		{version: migrationCreateQuotaCycleSnapshots, run: createQuotaCycleSnapshotsMigration},
	}
}
