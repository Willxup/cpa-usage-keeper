...
const (
	...
	migrationAddModelPriceSyncMetadata              = "20260616_add_model_price_sync_metadata"
)
...
func orderedMigrations() []databaseMigration {
	return []databaseMigration{
		...
		{version: migrationAddModelPriceSyncMetadata, run: addModelPriceSyncMetadataMigration},
	}
}
