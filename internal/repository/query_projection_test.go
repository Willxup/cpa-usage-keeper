...
func TestRepositoryQueriesAvoidKnownFullEntityReads(t *testing.T) {
	...
	assertFileContains(t, "usage.go",
		...
		"usageOverviewRawEventProjectionColumns = \"api_group_key, provider, auth_type, model, service_tier, timestamp, source, auth_index, failed, latency_ms, ttft_ms, input_tokens, output_tokens, reasoning_tokens, cached_tokens, cache_read_tokens, cache_creation_tokens, total_tokens\"",
	)
