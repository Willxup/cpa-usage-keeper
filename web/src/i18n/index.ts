  ...
  en: {
    translation: {
      ...
      usage_stats: {
        ...
        request_events_limit_hint: 'Showing the latest {{shown}} of {{total}} matching events.',
        ...
        service_health_subtitle: 'A compact reliability strip for the latest 24 hours of request outcomes.',
  ...
  zh: {
    translation: {
      ...
      usage_stats: {
        ...
        request_events_limit_hint: '当前显示最近 {{shown}} / {{total}} 条匹配事件。',
        ...
        service_health_subtitle: '用紧凑的可靠性条带展示最近 24 小时的请求结果。',
