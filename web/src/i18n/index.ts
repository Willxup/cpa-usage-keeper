  ...
  en: {
    translation: {
      ...
      usage_stats: {
        ...
        credentials_inspection_disable_limited_result: 'Disabled {disabled}, skipped {skipped}, failed {failed}',
  ...
  zh: {
    translation: {
      ...
      usage_stats: {
        ...
        credentials_inspection_disable_limited_result: '已临时禁用 {disabled} 个，跳过 {skipped} 个，失败 {failed} 个',
  ...
  'zh-TW': {
    translation: {
      ...
      usage_stats: {
        ...
        credentials_inspection_disable_limited_result: '已臨時禁用 {disabled} 個，跳過 {skipped} 個，失敗 {failed} 個',
